  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 16 03 00 00       	call   379 <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 19 03 00 00       	call   3c1 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 e2 02 00 00       	call   3a1 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 d9 02 00 00       	call   3a9 <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 ce 02 00 00       	call   3c1 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 8a 02 00 00       	call   399 <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 89 02 00 00       	call   3a9 <close>

  wait();
 120:	e8 64 02 00 00       	call   389 <wait>

  exit();
 125:	e8 57 02 00 00       	call   381 <exit>
 ...
 456:	89 d3                	mov    %edx,%ebx
{
 ...
 4de:	56                   	push   %esi
 4df:	57                   	push   %edi
 4e0:	e8 bc fe ff ff       	call   3a1 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 559:	e8 43 fe ff ff       	call   3a1 <write>
 ...
 5ce:	e8 ce fd ff ff       	call   3a1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 641:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 644:	e8 58 fd ff ff       	call   3a1 <write>
        ap++;
 ...
 6bb:	57                   	push   %edi
 6bc:	53                   	push   %ebx
 6bd:	e8 df fc ff ff       	call   3a1 <write>
        while(*s != 0){
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 54 0b 00 00       	mov    %eax,0xb54
    p->s.size += bp->s.size;
...
malloc(int nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
 ...
 7db:	e8 29 fc ff ff       	call   409 <sbrk>
  if(p == (char*)-1)
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 847:	0b 00 00 
    base.s.size = 0;
 84a:	bf 58 0b 00 00       	mov    $0xb58,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 856:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 85b:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 862:	00 00 00 
    if(p->s.size >= nunits){
