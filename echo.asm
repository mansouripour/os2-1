...
main(int argc, char *argv[])
{
  ...
  exit();
  64:	e8 48 02 00 00       	call   2b1 <exit>
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
  ...
  f1:	31 c0                	xor    %eax,%eax
{
  ...
  for(n = 0; s[n]; n++)
  f8:	80 3a 00             	cmpb   $0x0,(%edx)
  fb:	74 0c                	je     109 <strlen+0x19>
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 60 0a 00 00       	mov    %eax,0xa60
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(int nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 60 0a 00 00    	mov    0xa60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d 60 0a 00 00    	mov    0xa60,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	8b 15 60 0a 00 00    	mov    0xa60,%edx
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf 64 0a 00 00       	mov    $0xa64,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 64 0a 00 00 64 	movl   $0xa64,0xa64
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 68 0a 00 00 00 	movl   $0x0,0xa68
 792:	00 00 00 
    if(p->s.size >= nunits){
