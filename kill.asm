...
main(int argc, char **argv)
{
  ...
  38:	e8 94 02 00 00       	call   2d1 <kill>
  for(i=1; i<argc; i++)
  3d:	83 c4 10             	add    $0x10,%esp
  40:	39 f3                	cmp    %esi,%ebx
  42:	75 e4                	jne    28 <main+0x28>
  exit();
  44:	e8 58 02 00 00       	call   2a1 <exit>
    printf(2, "usage: kill pid...\n");
  49:	50                   	push   %eax
  4a:	50                   	push   %eax
  ...
  52:	e8 d9 03 00 00       	call   430 <printf>
    exit();
  57:	e8 45 02 00 00       	call   2a1 <exit>
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
...
malloc(int nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 5c 0a 00 00    	mov    0xa5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 5c 0a 00 00    	mov    0xa5c,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf 60 0a 00 00       	mov    $0xa60,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 782:	00 00 00 
    if(p->s.size >= nunits){
