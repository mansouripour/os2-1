    ...
    2d44:	31 ff                	xor    %edi,%edi
{
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fa9:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3026:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3040:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3072:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3105:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    311c:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3138:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    314f:	ff 35 48 5e 00 00    	pushl  0x5e48
...
00003170 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    317f:	ff 35 48 5e 00 00    	pushl  0x5e48
  ...
  printf(stdout, "validate ok\n");
    ...
    31e9:	ff 35 48 5e 00 00    	pushl  0x5e48
...
00003220 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    326b:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3283:	ff 35 48 5e 00 00    	pushl  0x5e48
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    3300:	c7 04 85 60 5e 00 00 	movl   $0x5420,0x5e60(,%eax,4)
    3307:	20 54 00 00 
    ...
    331a:	ff 35 48 5e 00 00    	pushl  0x5e48
    args[MAXARG-1] = 0;
    ...
    3347:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    3377:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    338e:	ff 35 48 5e 00 00    	pushl  0x5e48
    ...
    33a5:	31 f6                	xor    %esi,%esi
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3549:	50                   	push   %eax
    354a:	e8 c2 03 00 00       	call   3911 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 22 03 00 00       	call   38b9 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 24 03 00 00       	call   38c9 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 e4 02 00 00       	call   38c1 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 d1 02 00 00       	call   38c1 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 fe 02 00 00       	call   3901 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 33 03 00 00       	call   3949 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 b4 02 00 00       	call   38d9 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 bc 02 00 00       	call   38e9 <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3651:	e8 6b 02 00 00       	call   38c1 <exit>
    ...
    3701:	31 c0                	xor    %eax,%eax
{
    ...
    3705:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
    3708:	80 3a 00             	cmpb   $0x0,(%edx)
    370b:	74 0c                	je     3719 <strlen+0x19>
    370d:	8d 76 00             	lea    0x0(%esi),%esi
    3710:	83 c0 01             	add    $0x1,%eax
    3713:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
    3717:	75 f7                	jne    3710 <strlen+0x10>
    ;
  return n;
}
    3719:	5d                   	pop    %ebp
    ...
    3996:	89 d3                	mov    %edx,%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3a1e:	56                   	push   %esi
    3a1f:	57                   	push   %edi
    3a20:	e8 bc fe ff ff       	call   38e1 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3a99:	e8 43 fe ff ff       	call   38e1 <write>
  ...
  write(fd, &c, 1);
    ...
    3afa:	e8 e2 fd ff ff       	call   38e1 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
    ...
    3b0e:	e8 ce fd ff ff       	call   38e1 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    3b84:	e8 58 fd ff ff       	call   38e1 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3bfb:	57                   	push   %edi
    3bfc:	53                   	push   %ebx
    3bfd:	e8 df fc ff ff       	call   38e1 <write>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c21:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
{
    ...
    3c46:	73 10                	jae    3c58 <free+0x38>
{
  ...
  freep = p;
    ...
    3c71:	5b                   	pop    %ebx
  freep = p;
    3c72:	a3 e0 5e 00 00       	mov    %eax,0x5ee0
}
    3c77:	5e                   	pop    %esi
    3c78:	5f                   	pop    %edi
    3c79:	5d                   	pop    %ebp
  ...
  freep = p;
    3c9a:	a3 e0 5e 00 00       	mov    %eax,0x5ee0
    p->s.size += bp->s.size;
...
malloc(int nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cbc:	8b 3d e0 5e 00 00    	mov    0x5ee0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d09:	8b 3d e0 5e 00 00    	mov    0x5ee0,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d1b:	e8 29 fc ff ff       	call   3949 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3d37:	8b 15 e0 5e 00 00    	mov    0x5ee0,%edx
    ...
    3d64:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3d67:	89 15 e0 5e 00 00    	mov    %edx,0x5ee0
}
    ...
    3d7f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
    3d80:	c7 05 e0 5e 00 00 e4 	movl   $0x5ee4,0x5ee0
    3d87:	5e 00 00 
    base.s.size = 0;
    3d8a:	bf e4 5e 00 00       	mov    $0x5ee4,%edi
    base.s.ptr = freep = prevp = &base;
    3d8f:	c7 05 e4 5e 00 00 e4 	movl   $0x5ee4,0x5ee4
    3d96:	5e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d99:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3d9b:	c7 05 e8 5e 00 00 00 	movl   $0x0,0x5ee8
    3da2:	00 00 00 
    if(p->s.size >= nunits){
