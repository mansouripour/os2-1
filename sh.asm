...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 31 0d 00 00       	call   d61 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 c4 0c 00 00       	call   d19 <fork>
  if(pid == -1)
    ...
    wait();
      66:	e8 be 0c 00 00       	call   d29 <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
  ...
  exit();
      95:	e8 87 0c 00 00       	call   d21 <exit>
      ...
      if(chdir(buf+3) < 0)
      b5:	e8 d7 0c 00 00       	call   d91 <chdir>
      ...
      db:	50                   	push   %eax
      dc:	e8 68 0c 00 00       	call   d49 <close>
      break;
...
00000160 <panic>:
{
  ...
  exit();
     175:	e8 a7 0b 00 00       	call   d21 <exit>
...
00000180 <runcmd>:
{
  ...
  pid = fork();
     1cd:	e8 47 0b 00 00       	call   d19 <fork>
  if(pid == -1)
    ...
    close(p[0]);
     ...
     1e9:	e8 5b 0b 00 00       	call   d49 <close>
    close(p[1]);
     1ee:	58                   	pop    %eax
     1ef:	ff 75 f4             	pushl  -0xc(%ebp)
     1f2:	e8 52 0b 00 00       	call   d49 <close>
    wait();
     1f7:	e8 2d 0b 00 00       	call   d29 <wait>
    wait();
     1fc:	e8 28 0b 00 00       	call   d29 <wait>
    break;
     201:	83 c4 10             	add    $0x10,%esp
     204:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    exit();
     208:	e8 14 0b 00 00       	call   d21 <exit>
  pid = fork();
     20d:	e8 07 0b 00 00       	call   d19 <fork>
  if(pid == -1)
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     22d:	52                   	push   %edx
     22e:	50                   	push   %eax
     22f:	e8 25 0b 00 00       	call   d59 <exec>
  ...
  pid = fork();
     24b:	e8 c9 0a 00 00       	call   d19 <fork>
  if(pid == -1)
    ...
    wait();
     25d:	e8 c7 0a 00 00       	call   d29 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     273:	e8 d1 0a 00 00       	call   d49 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     278:	59                   	pop    %ecx
     279:	58                   	pop    %eax
     27a:	ff 73 10             	pushl  0x10(%ebx)
     27d:	ff 73 08             	pushl  0x8(%ebx)
     280:	e8 dc 0a 00 00       	call   d61 <open>
    ...
    panic("runcmd");
     ...
     2af:	e8 fc 0b 00 00       	call   eb0 <printf>
      exit();
     2b4:	e8 68 0a 00 00       	call   d21 <exit>
      panic("pipe");
     ...
     2c9:	6a 01                	push   $0x1
     2cb:	e8 79 0a 00 00       	call   d49 <close>
      dup(p[1]);
     2d0:	58                   	pop    %eax
     2d1:	ff 75 f4             	pushl  -0xc(%ebp)
     2d4:	e8 c0 0a 00 00       	call   d99 <dup>
      close(p[0]);
     2d9:	58                   	pop    %eax
     2da:	ff 75 f0             	pushl  -0x10(%ebp)
     2dd:	e8 67 0a 00 00       	call   d49 <close>
      close(p[1]);
     2e2:	58                   	pop    %eax
     2e3:	ff 75 f4             	pushl  -0xc(%ebp)
     2e6:	e8 5e 0a 00 00       	call   d49 <close>
      runcmd(pcmd->left);
     2eb:	58                   	pop    %eax
     ...
     2f7:	6a 00                	push   $0x0
     2f9:	e8 4b 0a 00 00       	call   d49 <close>
      dup(p[0]);
     2fe:	5a                   	pop    %edx
     2ff:	ff 75 f0             	pushl  -0x10(%ebp)
     302:	e8 92 0a 00 00       	call   d99 <dup>
      close(p[0]);
     307:	59                   	pop    %ecx
     308:	ff 75 f0             	pushl  -0x10(%ebp)
     30b:	e8 39 0a 00 00       	call   d49 <close>
      close(p[1]);
     310:	58                   	pop    %eax
     311:	ff 75 f4             	pushl  -0xc(%ebp)
     314:	e8 30 0a 00 00       	call   d49 <close>
      runcmd(pcmd->right);
     319:	58                   	pop    %eax
...
00000330 <fork1>:
{
  ...
  pid = fork();
     336:	e8 de 09 00 00       	call   d19 <fork>
  if(pid == -1)
     ...
     489:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ad:	50                   	push   %eax
     4ae:	68 d8 18 00 00       	push   $0x18d8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fd:	50                   	push   %eax
     4fe:	68 d8 18 00 00       	push   $0x18d8
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 d0 18 00 00       	push   $0x18d0
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 d8 18 00 00       	push   $0x18d8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 d8 18 00 00       	push   $0x18d8
  ...
  *ps = s;
  ...
  return *s && strchr(toks, *s);
     ...
     63f:	e8 5c 05 00 00       	call   ba0 <strchr>
...
strchr(const char *s, char c)
{
  ...
  for(; *s; s++)
     baa:	0f b6 18             	movzbl (%eax),%ebx
     bad:	84 db                	test   %bl,%bl
     baf:	74 1d                	je     bce <strchr+0x2e>
     bb1:	89 d1                	mov    %edx,%ecx
    if(*s == c)
     bb3:	38 d3                	cmp    %dl,%bl
  ...
  return 0;
     ...
     bd1:	5d                   	pop    %ebp
     bd2:	c3                   	ret    
     bd3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     ...
     be5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     bfb:	8d 45 e7             	lea    -0x19(%ebp),%eax
     bfe:	6a 01                	push   $0x1
     c00:	50                   	push   %eax
     c01:	6a 00                	push   $0x0
     c03:	e8 31 01 00 00       	call   d39 <read>
    if(cc < 1)
  ...
  for(i=0; i+1 < max; ){
     ...
     c24:	89 fe                	mov    %edi,%esi
     c26:	3b 5d 0c             	cmp    0xc(%ebp),%ebx
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     c6d:	e8 ef 00 00 00       	call   d61 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     c81:	50                   	push   %eax
     c82:	e8 f2 00 00 00       	call   d79 <fstat>
  close(fd);
     c87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     c8a:	89 c6                	mov    %eax,%esi
  close(fd);
     c8c:	e8 b8 00 00 00       	call   d49 <close>
  return r;
...
atoi(const char *s)
{
  ...
  while('0' <= *s && *s <= '9')
    ...
    n = n*10 + *s++ - '0';
     ...
     cd3:	8d 04 80             	lea    (%eax,%eax,4),%eax
...
00000d21 <exit>:
SYSCALL(exit)
     d21:	b8 02 00 00 00       	mov    $0x2,%eax
     d26:	cd 40                	int    $0x40
     d28:	c3                   	ret    

00000d29 <wait>:
SYSCALL(wait)
     d29:	b8 03 00 00 00       	mov    $0x3,%eax
     d2e:	cd 40                	int    $0x40
     d30:	c3                   	ret    

00000d31 <pipe>:
SYSCALL(pipe)
     d31:	b8 04 00 00 00       	mov    $0x4,%eax
     d36:	cd 40                	int    $0x40
     d38:	c3                   	ret    

00000d39 <read>:
SYSCALL(read)
     d39:	b8 05 00 00 00       	mov    $0x5,%eax
     d3e:	cd 40                	int    $0x40
     d40:	c3                   	ret    
...
00000d49 <close>:
SYSCALL(close)
     d49:	b8 15 00 00 00       	mov    $0x15,%eax
     d4e:	cd 40                	int    $0x40
     d50:	c3                   	ret    

00000d51 <kill>:
SYSCALL(kill)
     d51:	b8 06 00 00 00       	mov    $0x6,%eax
     d56:	cd 40                	int    $0x40
     d58:	c3                   	ret    

00000d59 <exec>:
SYSCALL(exec)
     d59:	b8 07 00 00 00       	mov    $0x7,%eax
     d5e:	cd 40                	int    $0x40
     d60:	c3                   	ret    

00000d61 <open>:
SYSCALL(open)
     d61:	b8 0f 00 00 00       	mov    $0xf,%eax
     d66:	cd 40                	int    $0x40
     d68:	c3                   	ret    

00000d69 <mknod>:
SYSCALL(mknod)
     d69:	b8 11 00 00 00       	mov    $0x11,%eax
     d6e:	cd 40                	int    $0x40
     d70:	c3                   	ret    

00000d71 <unlink>:
SYSCALL(unlink)
     d71:	b8 12 00 00 00       	mov    $0x12,%eax
     d76:	cd 40                	int    $0x40
     d78:	c3                   	ret    

00000d79 <fstat>:
SYSCALL(fstat)
     d79:	b8 08 00 00 00       	mov    $0x8,%eax
     d7e:	cd 40                	int    $0x40
     d80:	c3                   	ret    

00000d81 <link>:
SYSCALL(link)
     d81:	b8 13 00 00 00       	mov    $0x13,%eax
     d86:	cd 40                	int    $0x40
     d88:	c3                   	ret    

00000d89 <mkdir>:
SYSCALL(mkdir)
     d89:	b8 14 00 00 00       	mov    $0x14,%eax
     d8e:	cd 40                	int    $0x40
     d90:	c3                   	ret    

00000d91 <chdir>:
SYSCALL(chdir)
     d91:	b8 09 00 00 00       	mov    $0x9,%eax
     d96:	cd 40                	int    $0x40
     d98:	c3                   	ret    

00000d99 <dup>:
SYSCALL(dup)
     d99:	b8 0a 00 00 00       	mov    $0xa,%eax
     d9e:	cd 40                	int    $0x40
     da0:	c3                   	ret    

00000da1 <getpid>:
SYSCALL(getpid)
     da1:	b8 0b 00 00 00       	mov    $0xb,%eax
     da6:	cd 40                	int    $0x40
     da8:	c3                   	ret    

00000da9 <sbrk>:
SYSCALL(sbrk)
     da9:	b8 0c 00 00 00       	mov    $0xc,%eax
     dae:	cd 40                	int    $0x40
     db0:	c3                   	ret    

00000db1 <sleep>:
SYSCALL(sleep)
     db1:	b8 0d 00 00 00       	mov    $0xd,%eax
     db6:	cd 40                	int    $0x40
     db8:	c3                   	ret    

00000db9 <uptime>:
SYSCALL(uptime)
     db9:	b8 0e 00 00 00       	mov    $0xe,%eax
     dbe:	cd 40                	int    $0x40
     dc0:	c3                   	ret    

00000dc1 <getChild>:
SYSCALL(getChild)
     dc1:	b8 16 00 00 00       	mov    $0x16,%eax
     dc6:	cd 40                	int    $0x40
     dc8:	c3                   	ret    

00000dc9 <getCount>:
SYSCALL(getCount)
     dc9:	b8 17 00 00 00       	mov    $0x17,%eax
     dce:	cd 40                	int    $0x40
     dd0:	c3                   	ret    

00000dd1 <getppid>:
SYSCALL(getppid)
     dd1:	b8 18 00 00 00       	mov    $0x18,%eax
     dd6:	cd 40                	int    $0x40
     dd8:	c3                   	ret    

00000dd9 <changePolicy>:
SYSCALL(changePolicy)
     dd9:	b8 19 00 00 00       	mov    $0x19,%eax
     dde:	cd 40                	int    $0x40
     de0:	c3                   	ret    
     ...
     df6:	89 d3                	mov    %edx,%ebx
{
  ...
  write(fd, &c, 1);
     ...
     e7e:	56                   	push   %esi
     e7f:	57                   	push   %edi
     e80:	e8 bc fe ff ff       	call   d41 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     ef9:	e8 43 fe ff ff       	call   d41 <write>
  ...
  write(fd, &c, 1);
     ...
     f5a:	e8 e2 fd ff ff       	call   d41 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
     ...
     f6e:	e8 ce fd ff ff       	call   d41 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
     fe4:	e8 58 fd ff ff       	call   d41 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    105b:	57                   	push   %edi
    105c:	53                   	push   %ebx
    105d:	e8 df fc ff ff       	call   d41 <write>
        while(*s != 0){
    ...
    10a6:	73 10                	jae    10b8 <free+0x38>
{
  ...
  freep = p;
    ...
    10d1:	5b                   	pop    %ebx
  freep = p;
    10d2:	a3 44 19 00 00       	mov    %eax,0x1944
}
    10d7:	5e                   	pop    %esi
    10d8:	5f                   	pop    %edi
    10d9:	5d                   	pop    %ebp
...
malloc(int nbytes)
{
  ...
  if((prevp = freep) == 0){
    111c:	8b 3d 44 19 00 00    	mov    0x1944,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1169:	8b 3d 44 19 00 00    	mov    0x1944,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    117b:	e8 29 fc ff ff       	call   da9 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    1197:	8b 15 44 19 00 00    	mov    0x1944,%edx
    ...
    11c4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    11c7:	89 15 44 19 00 00    	mov    %edx,0x1944
}
    ...
    11df:	90                   	nop
    base.s.ptr = freep = prevp = &base;
    11e0:	c7 05 44 19 00 00 48 	movl   $0x1948,0x1944
    11e7:	19 00 00 
    base.s.size = 0;
    11ea:	bf 48 19 00 00       	mov    $0x1948,%edi
    base.s.ptr = freep = prevp = &base;
    11ef:	c7 05 48 19 00 00 48 	movl   $0x1948,0x1948
    11f6:	19 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    11fb:	c7 05 4c 19 00 00 00 	movl   $0x0,0x194c
    1202:	00 00 00 
    if(p->s.size >= nunits){
