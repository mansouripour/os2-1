...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 55 03 00 00       	call   391 <open>
  ...
  57:	e8 1d 03 00 00       	call   379 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 e8 02 00 00       	call   351 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  ...
  73:	e8 68 04 00 00       	call   4e0 <printf>
      exit();
  78:	e8 d4 02 00 00       	call   351 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 c5 02 00 00       	call   351 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 c1 02 00 00       	call   371 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 9f 02 00 00       	call   369 <read>
  ...
  e6:	e8 f5 03 00 00       	call   4e0 <printf>
      exit();
  eb:	e8 61 02 00 00       	call   351 <exit>
  ...
  f9:	e8 e2 03 00 00       	call   4e0 <printf>
    exit();
  fe:	e8 4e 02 00 00       	call   351 <exit>
 ...
 191:	31 c0                	xor    %eax,%eax
{
 ...
 195:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
 198:	80 3a 00             	cmpb   $0x0,(%edx)
 19b:	74 0c                	je     1a9 <strlen+0x19>
