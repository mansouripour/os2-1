...
main(int argc, char *argv[])
{
  ...
  3a:	e8 f1 01 00 00       	call   230 <grep>
    exit();
  3f:	e8 3d 05 00 00       	call   581 <exit>
  ...
  5d:	e8 47 05 00 00       	call   5a9 <close>
  for(i = 2; i < argc; i++){
  ...
  6d:	6a 00                	push   $0x0
  6f:	ff 33                	pushl  (%ebx)
  71:	e8 4b 05 00 00       	call   5c1 <open>
  ...
  89:	e8 82 06 00 00       	call   710 <printf>
      exit();
  8e:	e8 ee 04 00 00       	call   581 <exit>
  }
  exit();
  93:	e8 e9 04 00 00       	call   581 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  98:	51                   	push   %ecx
  99:	51                   	push   %ecx
  ...
  a1:	e8 6a 06 00 00       	call   710 <printf>
    exit();
  a6:	e8 d6 04 00 00       	call   581 <exit>
  ab:	66 90                	xchg   %ax,%ax
  ad:	66 90                	xchg   %ax,%ax
  af:	90                   	nop
 ...
 239:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
{
 ...
 260:	e8 34 03 00 00       	call   599 <read>
 ...
 2ce:	53                   	push   %ebx
 2cf:	6a 01                	push   $0x1
 2d1:	e8 cb 02 00 00       	call   5a1 <write>
 ...
 306:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
      memmove(buf, p, m);
 309:	e8 42 02 00 00       	call   550 <memmove>
 ...
 3c1:	31 c0                	xor    %eax,%eax
{
 ...
 3c5:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
 3c8:	80 3a 00             	cmpb   $0x0,(%edx)
 3cb:	74 0c                	je     3d9 <strlen+0x19>
 ...
 445:	31 f6                	xor    %esi,%esi
{
 ...
 460:	50                   	push   %eax
 461:	6a 00                	push   $0x0
 463:	e8 31 01 00 00       	call   599 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4cd:	e8 ef 00 00 00       	call   5c1 <open>
  if(fd < 0)
 ...
 4e1:	50                   	push   %eax
 4e2:	e8 f2 00 00 00       	call   5d9 <fstat>
  close(fd);
 4e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4ea:	89 c6                	mov    %eax,%esi
  close(fd);
 4ec:	e8 b8 00 00 00       	call   5a9 <close>
  return r;
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 562:	01 c2                	add    %eax,%edx
  dst = vdst;
 564:	89 c7                	mov    %eax,%edi
 566:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 56d:	8d 76 00             	lea    0x0(%esi),%esi
    *dst++ = *src++;
 570:	a4                   	movsb  %ds:(%esi),%es:(%edi)
  while(n-- > 0)
 571:	39 fa                	cmp    %edi,%edx
 ...
 656:	89 d3                	mov    %edx,%ebx
{
 ...
 6de:	56                   	push   %esi
 6df:	57                   	push   %edi
 6e0:	e8 bc fe ff ff       	call   5a1 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 759:	e8 43 fe ff ff       	call   5a1 <write>
 ...
 7ba:	e8 e2 fd ff ff       	call   5a1 <write>
        putc(fd, c);
      } else {
 ...
 7ce:	e8 ce fd ff ff       	call   5a1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 841:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 844:	e8 58 fd ff ff       	call   5a1 <write>
        ap++;
 ...
 8bb:	57                   	push   %edi
 8bc:	53                   	push   %ebx
 8bd:	e8 df fc ff ff       	call   5a1 <write>
        while(*s != 0){
...
malloc(int nbytes)
{
 ...
 9db:	e8 29 fc ff ff       	call   609 <sbrk>
  if(p == (char*)-1)
