...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 c5 03 00 00       	call   401 <open>
  ...
  59:	e8 8b 03 00 00       	call   3e9 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 56 03 00 00       	call   3c1 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	pushl  (%ebx)
  ...
  75:	e8 d6 04 00 00       	call   550 <printf>
      exit();
  7a:	e8 42 03 00 00       	call   3c1 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 2f 03 00 00       	call   3c1 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 04 03 00 00       	call   3d9 <read>
 ...
 10f:	e8 2c 01 00 00       	call   240 <strchr>
 ...
 16f:	e8 dc 03 00 00       	call   550 <printf>
    exit();
 174:	e8 48 02 00 00       	call   3c1 <exit>
 ...
 201:	31 c0                	xor    %eax,%eax
{
 ...
 205:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
 208:	80 3a 00             	cmpb   $0x0,(%edx)
 20b:	74 0c                	je     219 <strlen+0x19>
 ...
 285:	31 f6                	xor    %esi,%esi
{
 ...
 29b:	8d 45 e7             	lea    -0x19(%ebp),%eax
 29e:	6a 01                	push   $0x1
 2a0:	50                   	push   %eax
 2a1:	6a 00                	push   $0x0
 2a3:	e8 31 01 00 00       	call   3d9 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 30d:	e8 ef 00 00 00       	call   401 <open>
  if(fd < 0)
 ...
 321:	50                   	push   %eax
 322:	e8 f2 00 00 00       	call   419 <fstat>
  close(fd);
 327:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 32a:	89 c6                	mov    %eax,%esi
  close(fd);
 32c:	e8 b8 00 00 00       	call   3e9 <close>
  return r;
...
atoi(const char *s)
{
 ...
 373:	8d 04 80             	lea    (%eax,%eax,4),%eax
 ...
 496:	89 d3                	mov    %edx,%ebx
{
 ...
 51e:	56                   	push   %esi
 51f:	57                   	push   %edi
 520:	e8 bc fe ff ff       	call   3e1 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 599:	e8 43 fe ff ff       	call   3e1 <write>
 ...
 60e:	e8 ce fd ff ff       	call   3e1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 681:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 684:	e8 58 fd ff ff       	call   3e1 <write>
        ap++;
 ...
 6fb:	57                   	push   %edi
 6fc:	53                   	push   %ebx
 6fd:	e8 df fc ff ff       	call   3e1 <write>
        while(*s != 0){
...
malloc(int nbytes)
{
 ...
 81b:	e8 29 fc ff ff       	call   449 <sbrk>
  if(p == (char*)-1)
